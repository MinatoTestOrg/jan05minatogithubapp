package com.minatogithuborganization.jan05minatogithubapp;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.minatogithuborganization.jan05minatogithubapp"})
@EnableCaching
...
public class Jan05minatoGithubAppApplication {

	public static void main(String[] args) {
		SpringApplication.run(Jan05minatoGithubAppApplication.class, args);
	}
