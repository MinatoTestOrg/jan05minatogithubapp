...
export class AppLayoutBaseService {
  ...
  config : any = {"left":[{"outline":false,"infiniteScroll":false,"urlIconFileName":"Company Logo.svg","valueChange":true,"logoFileName":"Company Logo.svg","currentNode":"d185e77d-7f55-48c4-8fd2-1e9ab1db00ae","mobileLogoFileName":"Company Logo.svg","element":"logo"},{"outline":false,"menuType":"fixed","hideSidebarOnCollapse":false,"element":"leftMenu"},{"outline":false,"element":"appTitle"}],"middle":[{"outline":false,"element":"leftPane"},{"outline":false,"element":"middlePane"},{"outline":false,"element":"rightPane"}],"right":[{"children":[{"outline":false,"link":"/logout","label":"Logout","element":"logout"}],"element":"user"},{"outline":false,"menuType":"float","element":"rightMenu"}]};
